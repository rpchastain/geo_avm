...
\begin{figure}[h]
\includegraphics{final_paper_files/figure-latex/unnamed-chunk-2-1} \caption{Please caption every figure}\label{fig:unnamed-chunk-2}
\end{figure}
...
\includegraphics{final_paper_files/figure-latex/unnamed-chunk-3-1} \caption{Please caption every figure}\label{fig:unnamed-chunk-3}
\end{sidewaysfigure}
